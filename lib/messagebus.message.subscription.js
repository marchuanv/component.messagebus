...
function MessageBusMessageSubscription({ messageId, callback, callbackValidate, success }) {
...
MessageBusMessageSubscription.prototype.validate = function() {
    ...
    if (!this.success) {
        throw new Error("messagebus message subscription requires a success value");
    }
};
